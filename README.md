...
The play can start with creating the cells (which will show up grids based on the size of the screen), create random symbosis by either click on the "GENERATE RANDOM SYMBOSIS" button or click on the cells directly. Once satisfied, click "START GAME" button and the simulation will start.
<br>
